        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockPrice = table.Column<float>(type: "real", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    total_anmt = table.Column<float>(type: "real", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductionOrders_Suppliers_SupplierId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "cac43a6e-f7bb-4448-baaf-1add431ccbbf", null, "User", "EMPLOYEE" },
                    { "cbc43a8e-f7bb-4445-baaf-1add431ffbbf", null, "Admin", "ADMINISTRATOR" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "CCCD", "ConcurrencyStamp", "DateCreated", "Email", "EmailConfirmed", "EmployeeCode", "EmployeeName", "Image", "LastModified", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Position", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { "8e445865-a24d-4543-a6c6-9443d048cdb9", 0, null, "b88ecf52-4ccb-44ea-a8c2-a2a838f75f08", null, "admin@localhost.com", true, null, "System Admin", null, null, false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEEiKgTSnwOnzNk/Ov7XrxBb7xUySHebK877tuYEJa0ZgpspyWuBaCA4Lk8ve4wpYzw==", null, false, null, "d3d6d173-6fdd-4c57-a2b9-955ae0ba946e", false, "admin@localhost.com" },
                    { "9e224968-33e4-4652-b7b7-8574d048cdb9", 0, null, "f4719eb2-21a6-443f-a1c8-44518194ce52", null, "user@localhost.com", true, null, "System User", null, null, false, null, "USER@LOCALHOST.COM", "USER@LOCALHOST.COM", "AQAAAAIAAYagAAAAEOxO2P3jSv3HrHMUtXgY6C4+TS3ZFmSasi+pGmotqoE05T+wd+hiz/SNXpkEZ0my4g==", null, false, null, "80eb931b-cd3a-42c8-beb2-12e976da7dfa", false, "user@localhost.com" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionOrders_SupplierId",
